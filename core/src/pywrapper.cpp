...
BOOST_PYTHON_MODULE(pywrapper) {
    ...
    boost::python::class_<ScoreCovarianceConfig, shared_ptr<ScoreCovarianceConfig>, boost::noncopyable>("ScoreCovarianceConfig")
            ...
            .def_readwrite("summary_stat_score_file", &ScoreCovarianceConfig::summary_stat_score_file)
            .def_readwrite("summary_stat_cov_file", &ScoreCovarianceConfig::summary_stat_cov_file)
