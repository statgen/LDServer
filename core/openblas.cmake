...
if (USE_OPENMP)
  ...
  if (OpenMP_FOUND)
      ...
      ## Using either Clang or AppleClang
      #if (CMAKE_Fortran_COMPILER_ID STREQUAL "GNU")
        #message(STATUS "Adding -lomp to link options due to combination of clang and GNU fortran")
        #set_property(TARGET ${OpenBLAS_LIBNAME} APPEND PROPERTY LINK_OPTIONS "-lomp")
        #set_property(TARGET ${OpenBLAS_LIBNAME} APPEND PROPERTY INTERFACE_LINK_OPTIONS "-lomp")
      #endif()
    #endif()
